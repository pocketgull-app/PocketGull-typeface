...
def create_precision_glyph_dict(weight=700):
    ...
    def draw_cyrillic_B(pen):
        ...
        pen.closePath()
    glyphs['\u0411'] = (draw_cyrillic_B, 540) # Б
    glyphs['\u0431'] = (draw_cyrillic_B, 540) # б
    ...
    glyphs['\u0413'] = (draw_cyrillic_G, 480) # Г
    glyphs['\u0433'] = (draw_cyrillic_G, 480) # г
    ...
    def draw_cyrillic_soft_sign(pen):
        ...
        pen.curveTo((410, BL + HW), (340, BL + HW), (60 + SW, BL + HW))
        pen.closePath()
    glyphs['\u042C'] = (draw_cyrillic_soft_sign, 540) # Ь
    glyphs['\u044C'] = (draw_cyrillic_soft_sign, 540) # ь

    # Map shared Cyrillic-Latin homoglyphs
    glyphs['\u0410'] = (draw_A, 570) # А
    glyphs['\u0412'] = (draw_B, 570) # В
    glyphs['\u0415'] = (draw_E, 530) # Е
    glyphs['\u041A'] = (draw_K, 550) # К
    glyphs['\u041C'] = (draw_M, 680) # М
    glyphs['\u041D'] = (draw_H, 580) # Н
    glyphs['\u041E'] = (draw_O, 600) # О
    glyphs['\u0420'] = (draw_P, 560) # Р
    glyphs['\u0421'] = (draw_C, 580) # С
    glyphs['\u0422'] = (draw_T, 540) # Т
    glyphs['\u0423'] = (draw_Y, 500) # У
    glyphs['\u0425'] = (draw_X, 540) # Х

    glyphs['\u0430'] = (draw_a, 470) # а
    glyphs['\u0435'] = (draw_e, 480) # е
    glyphs['\u043E'] = (draw_o, 480) # о
    glyphs['\u0440'] = (draw_p, 490) # р
    glyphs['\u0441'] = (draw_c, 450) # с
    glyphs['\u0443'] = (draw_y, 440) # у
    glyphs['\u0445'] = (draw_x, 450) # х
