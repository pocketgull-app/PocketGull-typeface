# Case Study 01: Canadian Aboriginal Syllabics (Inuktitut / Cree / Ojibwe)
...
In this case study, we document the architectural synthesis, optical calibration, and clinical verification of **Canadian Aboriginal Syllabics (Inuktitut / Cree / Ojibwe)** across the four foundational typefaces of the **PocketGull Superfamily**:
